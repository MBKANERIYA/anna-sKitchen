            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-16 text-center">
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a href="/Anna Kitchen Broucher - Final (3).pdf" download className="border-2 border-primary text-primary px-7 py-3 rounded-full font-semibold hover:bg-primary hover:text-white transition-all duration-300 text-sm">
                            Download Brochure
                        </a>
                    </div>
                </div>
